...
public class AtomBakedModel implements IBakedModel
{	
	private final IBakedModel base;
	
	public AtomBakedModel(IBakedModel base) {
		this.base = base;
	}
		...
		return new ItemOverrideList(base.getOverrides().getOverrides())
				{
					...
					public ResourceLocation applyOverride(ItemStack stack, World worldIn, EntityLivingBase entityIn) 
					{
						...
						if(!INITILIZED_ATOMS.contains(damage))
							VestigeChemistry.registerAtom(damage);
